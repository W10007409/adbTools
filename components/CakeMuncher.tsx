...
const TREAT_CONFIG: Record<TreatType, { emoji: string; points: number; color: string }> = {
  cupcake: { emoji: '?쭅', points: 100, color: '#ff80ab' },
  cookie: { emoji: '?뜧', points: 150, color: '#a1887f' },
  donut: { emoji: '?뜦', points: 200, color: '#f06292' },
  icecream: { emoji: '?뜣', points: 300, color: '#81d4fa' },
  cake: { emoji: '?뜲', points: 500, color: '#ffd54f' },
  cherry: { emoji: '?뜏', points: 1000, color: '#ef5350' }
};
